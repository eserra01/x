...
class ResCompany(models.Model):
  ...
  apply_inventory_adjustment = fields.Boolean(string="¿Aplicar ajuste de inventario en baja?", default=False)
  ...
  def create_account_move_ebita(self, company_id=False, sync_date=False, test_data = []):
    ...
    ### Sin creación de baja de ataudes
    if not company_id.apply_inventory_adjustment:
      try:  
      ...
      ### Con creación de baja de ataudes y urnas
      try:  
        # Se valida que estén todos los parámetros configurados      
