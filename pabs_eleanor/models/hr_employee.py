...
class HrEmployee(models.Model):
    ...
    birth_place = fields.Many2one(comodel_name="res.country.state", string="Lugar de nacimiento", domain="[('country_id','=',156)]")
    fathers_name = fields.Char(string="Nombre completo del padre")
    mothers_name = fields.Char(string="Nombre completo de la madre")
    infonavit_credit = fields.Char(string="INFONAVIT")
    pabs_eleanor_area_id = fields.Many2one(comodel_name="pabs.eleanor.area", string="Área", compute='_calc_area')
    boss = fields.Char(string="Patrón")
    total_internal_salary = fields.Float(string="Salario Interno total")
    ...
    daily_salary = fields.Float(string="Salario diario")
    integrated_daily_salary = fields.Float(string="Salario diario integrado")
    personal_file_name = fields.Char(string="Expediente")
    personal_file_file = fields.Binary(string="Expediente")  
    constancy_up_name = fields.Char(string="Constancia de alta")
    ...
    infonavit_credit_amortization = fields.Selection(
        ...
        string="Amortización crédito INFONAVIT")
    discount_value = fields.Float(string="Valor descuento")
    interest_conflict = fields.Char(string="Conflicto de interés")
