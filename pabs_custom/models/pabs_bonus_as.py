...
class BonusPabsAs(models.Model):
  _name = 'pabs.bonus.as'

  plan_id = fields.Many2one(comodel_name = 'product.product',required=True,string='Plan')
  min_value = fields.Float(string='Valor minimo',required=True)
  max_value = fields.Float(string='Valor Maximo',required=True)
  bonus = fields.Float(string='Valor asignado',required=True)
  ...
  def create(self, vals):
    ...
    return super(BonusPabsAs, self).create(vals)
  ...
  def unlink(self):
    ...
    return super(BonusPabsAs, self).unlink()
  ...
  def write(self, vals):
    ...
    return super(BonusPabsAs, self).write(vals)